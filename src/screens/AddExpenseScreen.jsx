...
const AddExpenseScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-rose-50 pb-20">
      {/* Header */}
      <div className="bg-gradient-to-r from-red-600 to-rose-600 text-white p-4 shadow-xl">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center justify-between mb-3">
            <button
              onClick={() => navigate('/')}
              className="flex items-center text-white hover:text-red-100 transition-colors text-sm"
            >
      ...
      <div className="max-w-2xl mx-auto px-3 py-4 sm:px-4 sm:py-6">
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-4 sm:p-5 border border-red-100">
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 text-base border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all outline-none"
                required
                autoComplete="name"
              />
            </div>
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {smartSuggestions.map((suggestion, index) => (
                      <button
                        ...
                        className="px-3 py-2 text-xs bg-red-50 text-red-700 rounded-lg hover:bg-red-100 transition-colors border border-red-200 font-medium"
                      >
                        {suggestion.label}
                      </button>
                    ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 text-base border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all outline-none bg-white appearance-none"
                  style={{
            ...
            <div>
              ...
              <textarea
                ...
                rows="3"
                className="w-full px-4 py-3 text-base border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all outline-none resize-none"
              />
            </div>
          </div>
